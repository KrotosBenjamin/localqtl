...
class RFMixReader(object):
    def __init__(self, rfmix_prefix_path, select_samples=None,
        ...
        """
        Class for reading haplotype infromation from RFMix output files

        rfmix_prefix_path: prefix to RFMix files
        select_samples: specify a subset of samples

        Notes:
          Use this command to generate RFMix files per chromosome:
